...
_Most often, a two-stage payment is used for payments by bank cards._ _Diagram omitted: Invoice Two Stage Flow Diagram (`assets/common/images/en/invoice-two-stage-flow.v1.png` is not present in this repository)._
