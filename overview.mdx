...
2.Let's sort keys in alphabetical sequence: `"amount", "currency", "payway", "shop_id", "shop_order_id"` 3. The line for generating the SHA256 hash will be as follows: `6320.91:840:card_invoice_usd:1520:5b0efa8a-153b-4421-abac-2aba4d772a86account-secret-key"` Where account-secret-key is the secret identification key for your account. You can request a key from the support service. 4. Let's get a hash expression of the generated line using Python code:
