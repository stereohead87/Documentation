...
`{"shop_id": 1520,"shop_order_id": "5b0efa8a-153b-4421-abac-2aba4d772a86","amount": "6320.91","currency": 840,"payway": "card_invoice_usd","description": "My test invoice #1","sign": "77a6f7a30876d480d4e771d08cb83800dd5cb874664c77e515ffc052b20293c6"}`
...
### Example of signature generation for a method [invoice/create](https://docs.m3ii.tech/#operation/post-invoice-create):
...
`"299.45:840:wallet_usd:79834981:117account-secret-key"`
...
You can check whether you have generated the signature correctly using the service [https://www.xorbin.com/tools/sha256-hash-calculator](https://www.xorbin.com/tools/sha256-hash-calculator).

**Security Scheme Type:** API Key

**RequestBody parameter name:** `sign`